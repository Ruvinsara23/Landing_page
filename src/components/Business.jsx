...
<h2 className={styles.heading2}> You do the business <br className='sm:block hidden' /> well handle the money
</h2>
...
<div className={`${layout.sectionImg} flex flex-col ml-[20px]`}>
